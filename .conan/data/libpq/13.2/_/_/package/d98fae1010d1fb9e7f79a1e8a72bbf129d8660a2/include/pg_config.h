...
#define CONFIGURE_ARGS " '--without-readline' '--without-zlib' '--without-openssl' '--prefix=/Users/jenkins/w/BuildSingleReference@2/.conan/data/libpq/13.2/_/_/package/d98fae1010d1fb9e7f79a1e8a72bbf129d8660a2' '--bindir=${prefix}/bin' '--sbindir=${prefix}/bin' '--libexecdir=${prefix}/bin' '--libdir=${prefix}/lib' '--includedir=${prefix}/include' '--oldincludedir=${prefix}/include' '--datarootdir=${prefix}/share' 'CFLAGS=-m64 -g -fPIC -isysroot /Users/administrator/Downloads/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX11.1.sdk -arch x86_64' 'LDFLAGS=-m64' 'LIBS=' 'CPPFLAGS=' 'CXXFLAGS=-m64 -g -fPIC -isysroot /Users/administrator/Downloads/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX11.1.sdk -arch x86_64'"
