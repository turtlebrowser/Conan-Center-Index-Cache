...
#define CONFIGURE_ARGS " '--without-readline' '--without-zlib' '--without-openssl' '--prefix=/Users/jenkins/w/BuildSingleReference@8/.conan/data/libpq/13.2/_/_/package/647afeb69d3b0a2d3d316e80b24d38c714cc6900' '--bindir=${prefix}/bin' '--sbindir=${prefix}/bin' '--libexecdir=${prefix}/bin' '--libdir=${prefix}/lib' '--includedir=${prefix}/include' '--oldincludedir=${prefix}/include' '--datarootdir=${prefix}/share' 'CFLAGS=-m64 -O3 -fPIC -isysroot /Users/administrator/Downloads/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX11.1.sdk -arch x86_64' 'LDFLAGS=-m64' 'LIBS=' 'CPPFLAGS=-DNDEBUG' 'CXXFLAGS=-m64 -O3 -fPIC -isysroot /Users/administrator/Downloads/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX11.1.sdk -arch x86_64'"
...
#define PG_VERSION_STR "PostgreSQL 13.2 on x86_64-apple-darwin20.3.0, compiled by Apple clang version 12.0.0 (clang-1200.0.32.29), 64-bit"
