...
#define CONFIGURE_ARGS " '--without-readline' '--without-zlib' '--without-openssl' '--prefix=/home/conan/w/BuildSingleReference/.conan/data/libpq/13.4/_/_/package/6af9cc7cb931c5ad942174fd7838eb655717c709' '--bindir=${prefix}/bin' '--sbindir=${prefix}/bin' '--libexecdir=${prefix}/bin' '--libdir=${prefix}/lib' '--includedir=${prefix}/include' '--oldincludedir=${prefix}/include' '--datarootdir=${prefix}/share' 'CC=/usr/bin/gcc' 'CFLAGS=-m64 -O3 -s -fPIC' 'LDFLAGS=-m64' 'LIBS=' 'CPPFLAGS=-DNDEBUG' 'CXX=/usr/bin/g++' 'CXXFLAGS=-m64 -O3 -s -fPIC'"
...
#define PG_VERSION_STR "PostgreSQL 13.4 on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 9.2.1-9ubuntu2) 9.2.1 20191008, 64-bit"
